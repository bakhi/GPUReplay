...
#define KBASE_PM_RUNTIME 1		// jin: turn this off not to show pm-related info
#endif
...
#define JIN_KBASE_TRACE_IDX(X, Y) KBASE_TRACE_CODE(X) - KBASE_TRACE_CODE(Y)
...
struct kbase_device {
...
#ifdef CONFIG_GR_IO_HISTORY
	struct kbase_io_history gr_io_history;
	struct file *gr_io_file;
	u64 gr_io_file_offset;
#endif
	...
	u32 reg_dump_cnt;
	u32 max_reg_snapshots;
	u32 nr_reg_snapshots;
	u32 *reg_snapshot;
	spinlock_t reg_dump_lock;
#endif
};
